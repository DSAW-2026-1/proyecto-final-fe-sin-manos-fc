...
export default function AdminRegister() {
  ...
  const validateStep1 = () => {
    ...
    else if (!form.email.endsWith('@admin.unisabana.edu.co')) e.email = 'Debe ser un correo de administrador (@admin.unisabana.edu.co)'
        ...
        <div style={{ background: 'var(--white)', borderRadius: 'var(--radius-xl)', padding: '36px 32px', boxShadow: '0 24px 60px rgba(0,0,0,0.4)' }}>
          ...
          {step === 1 ? (
            <>
              ...
              <p style={{ fontSize: 13, color: 'var(--gray-400)', marginBottom: 24 }}>Crea tu cuenta con correo de administrador</p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div className="input-group">
                  ...
                  <input className="input-field" type="email" placeholder="tu.nombre@admin.unisabana.edu.co" value={form.email} onChange={e => set('email', e.target.value)} />
